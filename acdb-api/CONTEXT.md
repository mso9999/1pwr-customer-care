...
| `pr_lookup.py` | HR-backed employee department→CC-role auto-mapping delegates + portfolio/organization list (Firestore). Canonical employee/dept source is `hr_directory.py` |
