...
def init_auth_db():
    ...
    with get_auth_db() as conn:
        ...
        # Comfort (1PWR0501) is the Benin IT lead. Keep her at onm_team — the
        # metering-platform tier (provisioning, commissioning, PTB linking,
        # addressing). Superadmin is broader than she needs, so no upgrade here.
