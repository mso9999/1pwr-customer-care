...
export default function MetersPage() {
  ...
  const fetchData = useCallback(() => {
    setLoading(true);
    const filterCol = filterSite ? 'community' : filterPlatform ? 'platform' : undefined;
    const filterVal = filterSite || filterPlatform || undefined;
    listRows('meters', {
      page,
      limit: 50,
  ...
  }, [page, search, filterSite, filterPlatform]);

  useEffect(fetchData, [fetchData]);
  useEffect(() => { setSelected(new Set()); }, [page, search, filterSite, filterPlatform]);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2 sm:space-y-0 sm:flex sm:gap-3 sm:flex-wrap">
        ...
        <select
          value={filterSite}
          onChange={e => { setFilterSite(e.target.value); setFilterPlatform(''); setPage(1); }}
        ...
        <select
          ...
          onChange={e => { setFilterPlatform(e.target.value); setFilterSite(''); setPage(1); }}
          className="w-full sm:w-auto px-3 py-2 border rounded-lg text-sm bg-white"
        >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between">
                        ...
                        <span className="text-xs text-gray-400 shrink-0 ml-2">{site}</span>
                      </div>
