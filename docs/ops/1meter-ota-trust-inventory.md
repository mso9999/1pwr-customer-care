...
| `OneMeter11, 13, 17, 18` | various | MAK check meters | `03:9E:44:...` (v2) | **v1.1.2** (Phase 2 relay-cmd subscriber) | OTA `1m-v1-1-2-relay-cmd-20260428132839` (thing group `MAK_V1_1_1`), 2026-04-28 | pending — verify via `prototype_meter_state.firmware_version='1.1.2'` once devices come online |
| `OneMeter14, 15, 16, 5` | various | various MAK | **presumed** `03:9E:44:...` (v2) | pre-1.1.1 | original provisioning; field team confirms no post-provisioning cert changes by them | pending — serial reflash to v1.1.2 by field team |
...
| 2026-04-28 | **Phase 2 firmware ships as v1.1.2** (`onepwr-aws-mesh@58df6f8`). Adds `oneMeter/<thing>/cmd/relay` subscriber + ack publisher (`main/tasks/onemeter_relay_cmd/`). OTA `1m-v1-1-2-relay-cmd-20260428132839` created against thing group `MAK_V1_1_1` (OneMeter11/13/17/18) using profile `1PWR_OTA_ESP32_v2`. Devices already on v1.1.1 OTA-upgrade in place; remaining MAK fleet members get serial-flashed to v1.1.2 directly. |
